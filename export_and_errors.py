...
def monitor_export(task, cancel_when_interrupted=True):
...
def send_image_to_asset(image, AOI, assetID, description=''):
...
def send_image_to_drive(image, AOI, filename, folder, description=''):
...
def send_table_to_drive(table, filename, folder, description=''):
